  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="pembayaran.php" class="br-menu-link active">
          <div class="br-menu-item">
    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Pembayaran SPP</h4>
        <!-- <p class="mg-b-0">Do big things with Bracket, the responsive bootstrap 4 admin template.</p> -->
      </div><!-- d-flex -->

      <div class="br-pagebody mg-t-5 pd-x-30">
      <div class="br-section-wrapper">
      <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Cek NISN Siswa</h6>
      ...
      <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="" method="POST">
                                    ...
                                    <h6 class="m-0 font-weight-bold">Cari NISN Siswa</h6>
                                    <br>
                                    ...
                                    <div class="form-group">
                                    <button type="submit" name ="submit" class="btn btn-teal">Cari</button>
                                    </div>
                                </form>    
                            </div> 
                        </div>
              ...
              ?>
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="table-responsive">
                            <table class="table table-borderless"  id="dataTable" cellpadding="0" cellspacing="0">
                              <?php
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold">Pembayaran SPP</h6>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                ?>
                                  <td style="color:#DC3545;"><strong><?php echo $data['keterangan']; ?></strong></td>
                                <?php
                                else :
                                ?>
                                  <td style="color:#17A2B8"><strong><?php echo $data['keterangan']; ?></strong></td>
                                <?php
                                endif;
                                ?>
                                ...
                                <td>
                                  ...
                                  ?>
                                    ...
                                    <a href="../report.php?nisn=<?php echo $data['nisn']; ?> &act=cetak&id=<?php echo $data['id_pembayaran'] ?>&nama=<?php echo $data['nama_petugas'] ?>" class="btn btn-info">Cetak</a>
                                  <?php
                                  endif;
                                  ?>
                                </td>
