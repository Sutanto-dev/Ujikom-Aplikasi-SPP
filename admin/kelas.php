...
<html lang="en">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Data Kelas</h6>
          <p class="mg-b-25 mg-lg-b-20">SMK Bina Wisata Lembang</p>
      <div class="table-responsive">
      <a href="tambah_kelas.php" class="btn btn-info">Tambah Data</a>
             ...
             ?>
                 <tr>
                   ...
                   <a href="edit_kelas.php?id=<?php echo $data['id_kelas'];?>" class="btn btn-warning">Edit</a>
                    ...
                    <a data-toggle="modal" data-target="#kelas-<?php echo $data['id_kelas'];?>" href="hapus_kelas.php" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                   $no++;
