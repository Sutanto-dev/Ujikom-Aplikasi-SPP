...
<html lang="en">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Data Petugas</h4>
        <!-- <p class="mg-b-0">Do big things with Bracket, the responsive bootstrap 4 admin template.</p> -->
      </div><!-- d-flex -->

      <div class="br-pagebody mg-t-5 pd-x-30">
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Data Petugas</h6>
                    ...
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="nisn" value="<?php echo $data['nisn']; ?>" placeholder="<?php echo $data['nisn']; ?>" > 
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">NIS: </label>
                            <input class="form-control" type="text" name="nis" value="<?php echo $data['nis']; ?>" placeholder="<?php echo $data['nis']; ?>">
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">Nama Lengkap: </label>
                            <input class="form-control" type="text" name="nama" value="<?php echo $data['nama']; ?>"  placeholder="<?php echo $data['nama']; ?>">
                            </div>
                            ...
                            <input class="form-control" type="text" name="alamat" value="<?php echo $data['alamat']; ?>"  placeholder="<?php echo $data['alamat']; ?>">
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">No. HP: </label>
                            <input class="form-control" type="text" name="notelp" value="<?php echo $data['nomor_telepon']; ?>"  placeholder="<?php echo $data['notelp']; ?>">
                            </div>
                            ...
                            <?php
                                ...
                                ;
                            ?>
                                <label for="form-control-label">Tahun Angkatan SPP</label>
