...
<html lang="en">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Data Petugas</h6>
          <p class="mg-b-25 mg-lg-b-20">SMK Bina Wisata Lembang</p>
      <div class="table-responsive">
      <a href="tambah_petugas.php" class="btn btn-info">Tambah Data</a>
      <div class="bd bd-gray-300 rounded table-responsive">
            <table width="1500px" class="table table-bordered ">
              <tr>
              ...
              <?php
                    ...
                    <td><a class="btn btn-warning" href="edit_petugas.php?id=<?php echo $data['id_petugas'];?>">Edit</a> 
                    <?php include 'app/modal_petugas.php'; ?>
                    <a data-toggle="modal" data-target="#petugas-<?php echo $data['id_petugas']; ?>" class="btn btn-danger" href="hapus_petugas.php">Hapus</a></td>
                 </tr>
                 <?php
                    $no++;
                   }
