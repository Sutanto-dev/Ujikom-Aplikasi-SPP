  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="petugas.php" class="br-menu-link active">
          <div class="br-menu-item">
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Data Petugas</h6>
                  ...
                  <form action="prosesedit_petugas.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        ?>
                            ...
                            <input class="form-control" type="text" name="id_petugas" value="<?php echo $id; ?>" readonly> 
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">Username: </label>
                            <input class="form-control" type="text" name="username" value="<?php echo $data['username']; ?>" placeholder="<?php echo $data['username']; ?>">
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">Password: </label>
                            <input class="form-control" type="text" name="password" value="<?php echo $data['password']; ?>"  placeholder="<?php echo $data['password']; ?>">
                            </div>

                            <div class="form-group">
                            <label class="form-control-label">Nama Petugas: </label>
                            <input class="form-control" type="text" name="nama_petugas" value="<?php echo $data['nama_petugas']; ?>"  placeholder="<?php echo $data['nama_petugas']; ?>">
                            </div>
