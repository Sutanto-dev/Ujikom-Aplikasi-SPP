...
<html lang="en">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Data SPP</h6>
          <p class="mg-b-25 mg-lg-b-20">SMK Bina Wisata Lembang</p>
      <div class="table-responsive">
      <a href="tambah_spp.php" class="btn btn-info">Tambah Data</a>
                                        ...
                                        <tr>
                                          <td><?php echo $no;?></td>
                                              ...
                                              <td>
                                                  ...
                                                  <a data-toggle="modal" data-target="#spp-<?php echo $data['id_spp']; ?>" class="btn btn-danger" href="hapus_petugas.php">Hapus</a></td>
                                        </tr>
                                        <?php
                                     $no++;
                                     }
