  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="spp.php" class="br-menu-link active">
          <div class="br-menu-item">
    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Data SPP</h4>
        <!-- <p class="mg-b-0">Do big things with Bracket, the responsive bootstrap 4 admin template.</p> -->
      </div><!-- d-flex -->

      <div class="br-pagebody mg-t-5 pd-x-30">
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Data SPP</h6>
                  ...
                  <form action="prosesedit_spp.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            ?>
                            <label class="form-control-label">ID SPP: </label>
                            <input class="form-control" type="text" name="id_spp" value="<?php echo $id; ?>" readonly> 
                            </div>

                        
                            <div class="form-group">
                            <label class="form-control-label">Tahun: </label>
                            <input class="form-control" type="text" name="tahun" value="<?php echo $data['tahun']; ?>" placeholder="<?php echo $data['username'];?>" required>
                            </div>
                        
                        
                            <div class="form-group">
                            <label class="form-control-label">Nominal: </label>
                            <input class="form-control" type="text" name="nominal" value="<?php echo $data['nominal']; ?>" placeholder="<?php echo $data['username'];?>" required>
                            </div>
