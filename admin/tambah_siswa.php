  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Tambah Data Siswa</h6>
                  ...
                  <form action="proses_tambah_siswa.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="id_siswa" value="<?php echo $urutan; ?>" readonly> 
                            </div>
                            ...
                            <input class="form-control" type="text" name="notelp"  placeholder="Masukan Nomor Telepon">
                            </div>
                            ...
                            ?>
                            <label class="form-control-label">Tahun Angkatan SPP : </label>
