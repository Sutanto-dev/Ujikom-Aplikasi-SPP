  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Tambah Data Kelas</h6>
                  ...
                  <form action="proses_tambah_kelas.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="id_kelas" value="<?php echo $urutan; ?>" readonly> 
                            </div>
                        
                        
                            <div class="form-group">
                            <label class="form-control-label">Nama Kelas: </label>
                            <input class="form-control" type="text" name="nama_kelas" placeholder="Masukan Nama Kelas">
                            </div>
                        
                        
                            <div class="form-group">
                            <label class="form-control-label">Kompetensi Keahlian: </label>
                            <input class="form-control" type="text" name="kompetensi_keahlian"  placeholder="Masukan Kompetensi Keahlian">
                            </div>
