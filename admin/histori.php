  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="histori.php" class="br-menu-link active">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-paper-outline tx-24"></i>
    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Histori Pembayaran</h4>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                              ...
                              <?php
                                $query = "SELECT a.id_pembayaran, a.nisn, a.jatuh_tempo, a.bulan, a.tgl_bayar, a.jumlah_bayar, a.nama_petugas, a.keterangan, b.nama from pembayaran AS a INNER JOIN siswa as b ON a.nisn = b.nisn where a.keterangan='Lunas' ";
                              ...
                              <thead class="thead-colored thead-teal">
                                ...
                                ?>
                                       <tr>
                                          ...
                                          ?>
                                            <td style="color:#1d2939;"><strong><?php echo $data['keterangan'];?></strong></td>
                                          <?php
                                          }else{
                                          ?>
                                             <td style="color:#00b297;"><strong><?php echo $data['keterangan'];?></strong></td>
                                          <?php
                                            }
                                          ?>
