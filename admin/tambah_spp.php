  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Tambah Data SPP</h6>
                  ...
                  <form action="proses_tambah_spp.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="id_spp" value="<?php echo $urutan; ?>" readonly> 
                            </div>
                        
                            <div class="form-group">
                            <label class="form-control-label">Tahun: </label>
                            <input class="form-control" type="text" name="tahun" placeholder="Masukan Password">
                            </div>
