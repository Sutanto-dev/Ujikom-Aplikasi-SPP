  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Tambah Data Petugas</h6>
                  ...
                  <form action="proses_tambah_petugas.php" method="POST">
                    <div class="form-layout form-layout-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="id_petugas" value="<?php echo $urutan; ?>" readonly> 
                            </div>
                            ...
                            <input class="form-control" type="text" name="nama_petugas"  placeholder="Masukan Password">
                            </div>

                            <div class="form-group mg-b-10-force">
                            <label class="form-control-label">Level: </label>
                            <input class="form-control" type="text" name="level" placeholder="Petugas" readonly>
                            </div>
